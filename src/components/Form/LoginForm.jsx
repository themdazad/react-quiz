    ...
    <>
      ...
      >
        ...
        <input
          ...
          className="bg-neutral-50 ring-[1px] ring-gray-200 rounded-lg p-2 md:p-3 placeholder:text-gray-300 text-xs md:text-sm focus:border-none placeholder:text-xs md:placeholder:text-sm focus:outline-none focus:ring-[1px] focus:ring-sky-500/80 "
        />{" "}
        <br />
        ...
        <button
          ...
          className={`flex rounded-full ${!loading
              ? "bg-sky-500 hover:bg-neutral-50 hover:text-sky-500"
              : "bg-sky-500/70 cursor-not-allowed"
        ...
        <p className="text-gray-600 text-xs font-semibold mt-3">
          Don't have account ?
          <Link className="ml-2 text-sky-500" to={"/register"}>
            Sign Up
          </Link>{" "}
        </p>
      </Form>
