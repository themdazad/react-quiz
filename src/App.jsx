...
function App() {
  ...
  return (
    <AnimateProvider className="flex flex-col text-sm md:mx-auto md:max-w-xl ">
      ...
      <button
        className="flex rounded-full bg-blue-500 p-1 py-2 md:py-2 justify-center font-semibold md:font-bold text-sm md:text-base text-center hover:bg-neutral-50 hover:text-orange-500 transition text-white"
        onClick={handleBegin}
      >
        Begin Test
      </button>
